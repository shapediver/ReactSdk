...
import AppBuilderInteractionWidgetComponent from "./AppBuilderInteractionWidgetComponent";
	...
	return <>
		{ widgets.map((w, i) => {
			if (isTextWidget(w))
				...
				return <AppBuilderInteractionWidgetComponent key={i} sessionId={sessionId} {...w.props} />;
			else
				return null;
		})}
	</>;
